...
#Selecting all yeti nodes before caching is the easiest way to cached 
#Based on the Concurrent Caching docs https://support.peregrinelabs.com/support/solutions/articles/66000481611-working-with-caches#Concurrent-Caching
